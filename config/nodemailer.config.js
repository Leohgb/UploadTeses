...
module.exports.sendConfirmationEmail = (name, email, confirmacao) => {
    transport.sendMail({
      ...
      html: `<h1>Confirmação de Email</h1>
          ...
          <input type='submit' style="margin-top:5px; cursor: pointer; ;border-color:#17a2b8; border: 1px solid transparent; background-color:#17a2b8; color:#fff; border-radius: 0.25rem; font-size: 1rem;
